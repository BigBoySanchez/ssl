...
## TEMP
run this: `python main_bertweet.py --dataset humaid --hf_model_id_short N/A --plm_id roberta-base --metric_combination cv --setup_local_logging --seed 1234 --pseudo_label_dir anh_4o --event california_wildfires_2018 --lbcl 50 --set_num 1 --data_dir ../../data 2>&1 | tee TEMP.txt`