...
rows = {
    "Zero-shot (GPT-5)":                metrics_for(r"..\zero-shot\humaid_zs.csv"),
    "BERT (100 lb/cl)":                 metrics_for(r"..\temp\pred_bert_int.csv"),
    "VerifyMatch (100 lb/cl)":          metrics_for(r"..\output\humaid_10_8_2.csv"),
}
