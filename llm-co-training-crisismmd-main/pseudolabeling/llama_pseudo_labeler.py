...
def main():
    ...
    if use_cheyenne:
        test_data_path=f"/home/b/bharanibala/mllmd/CrisisMMD_Modified/{task_name}/image_only.json"
        dev_data_path=f"/home/b/bharanibala/mllmd/crisismmd_datasplit_agreed_label/crisismmd_datasplit_agreed_label/task_{task_name}_text_img_agreed_lab_dev.tsv"
        result_file_path=f"/home/b/bharanibala/mllmd/llm_pseudo_labels/{task_name}/Llama-3.2-11B-Vision-Instruct-Huma-Zeroshot-Text-Image.json" 
    
    if use_beocat:
        test_data_path=f"/homes/bharanibala/mllmd/CrisisMMD_Modified/{task_name}/image_only.json"
        dev_data_path=f"/homes/bharanibala/crisismmd_datasplit_agreed_label/crisismmd_datasplit_agreed_label/task_{task_name}_text_img_agreed_lab_dev.tsv"
        result_file_path=f"/homes/bharanibala/mllmd/llm_pseudo_labels/{task_name}/Llama-3.2-11B-Vision-Instruct-Huma-Zeroshot-Text-Image.json"
